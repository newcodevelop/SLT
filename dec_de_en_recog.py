...
checkpoint_path = "./checkpoints/train/pman/threechannels"
...
def evaluate(video_test):
  ...
  return tf.squeeze(output, axis=0),tf.squeeze(output_en, axis=0), attention_weights
...
def translate(img,plot=''):
  result,result_en, attention_weights = evaluate(img)
